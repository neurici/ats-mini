...
{
  0, "Stiri", "Actualitati", "Informatii",
  "Sport", "Educatie", "Drama", "Cultura",
  "Stiinta", "Variat", "Muzica Pop", "Muzica Rock",
  "Muzica Usoara", "Clasica Usoara", "Clasica Serioasa", "Alta Muzica",
  "Vremea", "Finante", "Program pentru Copii", "Afacerii Sociale",
  "Religie", "Emisiune Telefonica", "Calatorii", "Timp Liber",
  "Muzica Jazz", "Muzica Country", "Muzica Nationala", "Muzica Veche",
  "Muzica Folk", "Documentar", "TEST", "! ALERTA !"
};

const char *rbdsProgramTypes[32] =
{
  0, "Stiri", "Informatii", "Sport",
  "Talk", "Rock", "Rock Clasic", "Hituri pentru Adulti",
  "Rock Lent", "Top 40", "Country", "Muzica Veche",
  "Muzica Lenta", "Nostalgie", "Jazz", "Clasica",
  "R & B", "R & B Lent", "Limba Straina", "Muzica Religioasa",
  "Discutii Religioase", "Personalitate", "Public", "Universitar",
  "Talk Spaniol", "Muzica Spaniola", "Hip Hop", 0,
  0, "Vremea", "TEST", "! ALERTA !"
};
